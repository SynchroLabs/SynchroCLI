...
commander.command('add [appname]', 'add the existing Synchro app to the current configuration');
commander.command('remove [appname]', 'remove the existing Synchro app to the current configuration');
