...
commander.command('delete [appName]', 'remove a Synchro app from the current configuration and delete its contents');
commander.command('install [appReference] [appName]', 'install a remote Synchro app into the current configuration');
commander.command('syncdeps [appName]', 'ensure that dependencies of a Synchro app are installed on local server');
