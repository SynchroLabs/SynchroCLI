...
exports.installedAppNamesFromContainer = function(config, container)
{
...
{
	return (yield moduleStore.getAppContainersAwaitable()).indexOf(containerName) >= 0;
}
...
exports.installAppDependencies = function * (config, appName)
{
