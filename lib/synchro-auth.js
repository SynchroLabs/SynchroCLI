...
{
	// !!! This is doing the functional equivalent of basic authentication.  This would probably be fine
	//     if we were on an SSL connection.  An analog to digest authentication is probably a better approach.
	//
    var options = 
    {
