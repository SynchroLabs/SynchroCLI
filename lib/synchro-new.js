...
{
	util.getConfigOrExit(); // !!! Just for the check/exit, getLiveConfig should provide that also (fail silent unless param?)

	var config = util.getLiveConfig(command.config);
