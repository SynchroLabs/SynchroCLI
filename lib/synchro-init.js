...
wait.launchFiber(function()
{
	...
	// Use the host and token retrieved above to customize the npm-shrinkwrap.json...
	//
    ...
    wait.for(util.npmInstall, process.cwd());
    ...
    wait.for(util.npmInstall, path.resolve(process.cwd(), config.get('APP_ROOT_PATH')));
