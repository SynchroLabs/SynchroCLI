...
// !!! This is here is that install will copy an app from another location and install it in the current
//     configuration.
//
//     The location may be a URI that points to tarball.  It may be a short name reference to an app hosted
//     in a synchro.io repository of apps (sample and/or demo apps).
//
...
//
//     The location from which the app was installed will be recorded in the synchro.json file of the newly 
//     installed app, in part so that it can be updated later by using that location reference.
//
...
//     maybe, maybe looking in the remote synchro.json, etc).
//
